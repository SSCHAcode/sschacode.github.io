...
In this website you can find the instructions to [install and donwload](http://sscha.eu/download/) the code and tutorials that will help you understand how to use it with simple examples. You can find also all the documentation of the code. The crucial papers where the SSCHA theory was introduced can be found in the references and how to cite section.
